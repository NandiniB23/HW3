...
public class PasswordEvaluator {
	/**
	 * The code constructed is derived from the work of the FSM-Translated PasswordEvaluator created by Lynn Robert Carter.
	 * This code has been modified by Naji Mohamed, on January 23, 2025 to meet specifications of individual homework one.
	 * 
	 ...
	 * 
	 * Original Creator: Lynn Robert Carter
	 * 
	 * Version information constructed by original creator:
	...
	public static String evaluatePassword(String input) {
		...
		if(input.length() <= 0) return "*** Password Error *** The password is empty!";
		...
		while (running) {
			...
			if (currentChar >= 'A' && currentChar <= 'Z') {
				...
				// Return statement to specify being apart of the password
				return "*** Password Error *** An invalid character has been found!";
			}
			if (currentCharNdx >= 7) {
		...
		// errMessage to specify being apart of the password
		return errMessage + "conditions were not satisfied within the password.";
